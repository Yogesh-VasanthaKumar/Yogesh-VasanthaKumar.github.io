...
const displaySearchResults = (searchQuery = "") => {
    const filtered = emojiList.filter(e => {
        ...
        return (
            ...
            e.aliases.some(alias => alias.toLowerCase().includes(normalizedQuery)) ||
    ...
    if (filtered.length === 0) {
        emojiListContainer.innerHTML = "No matching emojis found.";
        return;
    }
    ...
    filtered.forEach(e => {
        ...
        aliases.textContent = e.aliases.join(", ").replaceAll("_", " ");
        ...
        emojiInfo.appendChild(aliases);
        emojiInfo.appendChild(description);

        emojiDiv.appendChild(emojiSymbol);
        emojiDiv.appendChild(emojiInfo);

        emojiListContainer.appendChild(emojiDiv);
    });
};
